    ...
    >
      ...
      <div className="absolute top-8 left-0 w-full z-30 pointer-events-none">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center opacity-65">
          <span className="font-semibold text-xs tracking-widest text-text-muted uppercase">Nossa Filosofia</span>
          <span className="font-semibold text-xs tracking-widest text-text-muted uppercase">Impulse Experiência</span>
        </div>
      </div>
      ...
      <div className="relative w-full max-w-6xl mx-auto px-6 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 h-[45vh] md:h-screen sticky top-0 flex flex-col justify-between py-8 z-20 bg-bg-base">
          ...
          <div className="w-full text-center opacity-50 pb-4 hidden md:block">
            <span className="text-[10px] tracking-widest text-text-muted uppercase">Role para explorar</span>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col z-10 pl-0 md:pl-16 relative">
          ...
          <div className="text-section-0 h-[70vh] md:h-screen flex items-center justify-start py-12 md:py-0">
            <div className="text-block w-full flex flex-col justify-center text-left">
              <span className="font-semibold text-xs md:text-sm tracking-widest text-text-muted uppercase mb-4">Apresentação</span>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-3 text-title leading-tight">
                Quer impressionar seus clientes?
              </h1>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter text-tertiary">
                Deixe conosco.
              </h1>
            </div>
          </div>
          ...
          <div className="text-section-1 h-[70vh] md:h-screen flex items-center justify-start py-12 md:py-0">
            <div className="text-block w-full flex flex-col justify-center text-left">
              <span className="text-text-muted text-xs md:text-sm font-bold tracking-widest uppercase mb-4">✦ Propósito</span>
              <h3 className="text-title text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-4">Valor de Marca</h3>
              <p className="text-text-main text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          <div className="text-section-2 h-[70vh] md:h-screen flex items-center justify-start py-12 md:py-0">
            <div className="text-block w-full flex flex-col justify-center text-left">
              <span className="text-text-muted text-xs md:text-sm font-bold tracking-widest uppercase mb-4">☉ Simplicidade</span>
              <h3 className="text-title text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-4">Navegação sem Atrito</h3>
              <p className="text-text-main text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          <div className="text-section-3 h-[70vh] md:h-screen flex items-center justify-start py-12 md:py-0">
            <div className="text-block w-full flex flex-col justify-center text-left">
              <span className="text-text-muted text-xs md:text-sm font-bold tracking-widest uppercase mb-4">❊ Arte & Detalhe</span>
              <h3 className="text-title text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-4">Design de Alta Costura</h3>
              <p className="text-text-main text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          <div className="text-section-4 h-[70vh] md:h-screen flex items-center justify-start py-12 md:py-0">
            <div className="text-block w-full flex flex-col justify-center text-left">
              <span className="text-text-muted text-xs md:text-sm font-bold tracking-widest uppercase mb-4">❦ Prazer Visual</span>
              <h3 className="text-title text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-4">Efeito Encantador</h3>
              <p className="text-text-main text-sm sm:text-base md:text-lg leading-relaxed">
